...
2. `.team/` ディレクトリ構造を作成:
   - team.json, status.json, specs/, output/, tasks/open/, tasks/closed/, prompts/, docs-snapshot/
...
cmux send --surface MANAGER "claude --dangerously-skip-permissions --model haiku '.team/prompts/manager.md を読んで指示に従ってください。'\n"
```
