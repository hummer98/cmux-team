...
- **Primary completion detection**: Conductor executes `cmux-team send CONDUCTOR_DONE --surface $CMUX_SURFACE --success true` → Message is sent to daemon's HTTP API `/api/messages`
