...
do_check() {
  ...
  # commands
  local cmd_count=0
  for cmd in team-init team-status team-disband team-research team-spec team-design team-impl team-review team-test team-sync-docs team-issue; do
